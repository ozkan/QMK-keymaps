...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_reviung41(
    ...
    _______,  _______,  _______,   _______,  TR_LABK,   TR_RABK,               TR_LCBR,  TR_RCBR,   TR_UNDS,  TR_DLR,   TR_HASH,  TR_GRV,
    _______,  _______,  _______,   _______,  _______,   _______,               TR_LBRC,  TR_RBRC,   TR_CIRC,  TR_TILD,  TR_BSLS,  KC_END,
  ...
  [_SPACE] = LAYOUT_reviung41(
    ...
    _______,  _______,  _______,  TR_SCED,  _______,  TR_PND,                _______,  _______,  S(TR_I),  TR_I,      TR_ODIA,  TR_QUOT,
    KC_LEFT,  _______,  _______,  TR_CCED,  _______,  _______,               _______,  _______,  _______,  _______,   TR_QUES,  KC_RGHT,
