...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_reviung41(
    ...
    _______,  _______,  _______,   _______,  _______,   _______,               TR_LCBR,  TR_RCBR,   TR_UNDS,  TR_DLR,   TR_HASH,  TR_GRV,
  ...
  [_SPACE] = LAYOUT_reviung41(
    ...
    KC_LEFT,  _______,  _______,  TR_CCED,  _______,  _______,               _______,  _______,  TR_LABK,  TR_RABK,   TR_QUES,  KC_RGHT,
